    ...
    <div class="container blog-container" id="blog">
    	<div class="row">
    		<div class="blog-body col-sm-10 col-md-10 col-lg-10 offset-md-1 offset-lg-1 text-center">
    			...
    			<p class="blog-text text-center">We will be sure to get in contact with you as soon as possible!  You will be redirected to the home page in a few seconds.</p>
    		</div>
    	</div>
    </div>
